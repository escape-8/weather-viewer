...
@section('auth-buttons')
    <a class="btn btn-light col-12" href="{{ route('user.create') }}">Register</a>
@endsection
...
@section('content')
    <div class="row col-5 border rounded px-4 py-4 my-5 mx-auto align-content-center align-self-center mb-6 shadow-sm h-50">
